...
return [
    ...
    */
    'bots'                         => [
        'mybot' => [
            'username'            => 'edmoney_bot',
            'token'               => env('TELEGRAM_BOT_TOKEN', '1297205833:AAGvt0eLPOP9FYFjb851ZWPriIG0-biQD3Q'),
            'certificate_path'    => env('TELEGRAM_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url'         => env('TELEGRAM_WEBHOOK_URL', 'https://www.edmoney.uz/edmoney_bot'),
            'commands'            => [
       ...
       // https://api.telegram.org/bot1297205833:AAGvt0eLPOP9FYFjb851ZWPriIG0-biQD3Q/getWebhookInfo
        ...
        //https://api.telegram.org/bot1297205833:AAGvt0eLPOP9FYFjb851ZWPriIG0-biQD3Q/deleteWebhook?url=https://www.edmoney.uz/edmoney_bot
        //        'mySecondBot' => [
