            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-8 text-2xl">
                        Welcome to your Ethno Delivery Money application!
                    </div>
                ...
                <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="https://laravel.com/docs">Customers</a></div>
                        </div>
                
                        <div class="ml-12">
                            <div class="mt-2 text-sm text-gray-500">
Общая число клиентов в системе: {{$customers}};<br>
Общая число куреров в системе: {{$couriers}};
                    ...
                    <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="https://laracasts.com">Money</a></div>
                        </div>
                
                        <div class="ml-12">
                            <div class="mt-2 text-sm text-gray-500">
                                <b>Общая прибыль</b><br>
                                Общая сумма: {{$usd_sum}} $ <br>
                                Общая сумма: {{$rub_sum}} рубль <br>
                                Общая сумма: {{$uzs_sum}} сум <br>
                                <b>Общие долги</b><br>
