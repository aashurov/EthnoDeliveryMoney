                      ...
                      <div class="panel-heading">
                        <div class="row">
                          <div class="col col-xs-6">
                            <h3 class="panel-title">Список долгов клиента {{$customers->id}} - {{$customers->flname}}</h3>
                          </div>
                          <div class="col col-xs-6 text-right">
                            <a class="btn btn-sm btn-primary btn-create"  href="{{ route('addloan') }}">Добавить</a>
                            <a class="btn btn-sm btn-primary btn-create"  href="{{ route('editcustomer',$customers->id) }}">Назад</a>
                      ...
                      @foreach ($loans as $loan)
                            <tr>
                              <td width="1px" >{{ ++$i }}</td>
                                ...
                                <td style="text-align:center">{{ $loan->zakg }}</td>
                                ...
                                <td style="text-align:center">{{ $loan->datereceive }}</td>
                                <td style="text-align:center" width="5px">
                                  <form action="{{route('deleteloan', $money->id)}}" method="POST", enctype="multipart/form-data">
                                    @csrf
                                    @method('POST')
                                    <a class="" href="{{ route('editloan',$money->id) }}"><i class="fa fa-pencil"></i></a>
